...
std::vector<VkDescriptorSet> DescriptorAllocatorGrowable::allocate(VkDevice device, std::vector<VkDescriptorSetLayout> &layout, void *pNext)
{
    ...
    std::vector<VkDescriptorSet> ds{layout.size()};
